...
<head>
    ...
    <title>Cadastro - Mundo dos Filmes</title>
...
<body>
    ...
    <div class="form-container">
            <form action="processa.php" method="post">
                ...
                <input type="text" required name="nome" id="nome" placeholder="Digite o nome completo"><br>
                <label for="email">E-mail:</label>
                <input type="email" required name="email" id="email" placeholder="Digite o seu email"><br>
                <label for="cpf">CPF:</label>
                <input type="text" required name="cpf" id="cpf" placeholder="Digite o seu CPF"><br>
