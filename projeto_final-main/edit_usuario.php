...
<head>
    ...
    <title>Contato - Mundo dos Filmes</title>
...
<br><br><br>
    ...
    <form action="proc_edit_usuarios.php" method="post">
        ...
        <label id="nomes">Nome:</label>
        <input type="text" name="nome" placeholder="Digite o nome completo" value="<?php echo
         $row_usuario['nome']; ?>"> <br><br> 
        <label id="nomes">E-mail:</label>
        <input type="email" name="email" placeholder="Digite o seu email" value="<?php echo 
        $row_usuario['nome']; ?>"> <br><br>
         <label id="nomes">CPF:</label>
        <input id="caixa" type="cpf" name="cpf" placeholder="Digite o seu CPF" value="<?php echo 
        $row_usuario['nome']; ?>"> <br><br> 
         <label id="nomes">Senha:</label>
        <input  type="senha" name="senha" placeholder="Digite sua Senha" value="<?php echo 
        $row_usuario['nome']; ?>"> <br><br>  
